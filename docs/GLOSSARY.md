...
**Canonical technical IDs:** Prefer `i18nKey` values from `ui_copy_registry.v1` as the stable identifier when discussing a term across PDF, SPA, and support docs.
...
| Term | Source | Notes |
| ------------------------------ | ------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------- |
| Question stems, hints, options | `question_bank.v1` | **Highest-risk** copy for translation; see ADR §2.5 — full QA per locale, no partial ship without Beta / policy. |
