...
| --- | ---: |
| design-system-raw-values-check (app scope) | 392 |
| design-system-enforcement-check (app scope) | 101 |
| **Total rows** (merged raw + enforcement) | **493** |
| **Deduped rows** (written to `compliance-findings.full.txt`) | **488** |
...
| File | Count |
| --- | ---: |
| `src/app/marketing/blocks/AuditCompare.tsx` | 22 |
| `src/app/features/report-viewer/components/ReportHeroCard.tsx` | 21 |
...
- [`compliance-findings.full.txt`](./compliance-findings.full.txt) — **488** lines
