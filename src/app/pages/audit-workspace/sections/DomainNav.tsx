      ...
      {visibleDomainKeys.map(key => {
        ...
        return (
          <motion.button
            ...
            className={cn(
              'relative flex w-full items-center gap-2.5 rounded-xl border px-2.5 py-2.5 text-left transition-all duration-150',
              active
                ? 'ds-audit-domain-nav-row-active'
            ...
            <div className="flex-1 min-w-0">
              <div
                className={cn(
                  ...
                  active ? 'text-[color:var(--sidebar-foreground)]' : 'text-[var(--text-secondary)]',
                )}
              >
                {DOMAIN_LABELS[key]}
              </div>
