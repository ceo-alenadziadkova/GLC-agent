export const CLIENT_AUDIT_VIEW_COPY = {
  ...
  links: {
    viewTimeline: 'Open execution timeline',
    timelineReady: 'Seasonal lanes and dependency order',
    viewReport: 'View your report',
    reportFinished: 'Your audit run has finished',
    viewStrategyLab: 'Open Strategy Lab details',
    strategyReady: 'Deep dive into node-level decisions',
  ...
  cockpit: {
    ...
    openLab: 'Strategy Lab details',
    adjustScopeTitle: 'Change scope or regenerate the roadmap',
    adjustScopeBody:
      'Adjusting domains or regenerating the roadmap creates a new plan version. Open Timeline setup to preview scope changes and confirm the next version.',
  },
  upgrade: {
