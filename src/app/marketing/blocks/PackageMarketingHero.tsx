      ...
      >
        ...
        <div className="mt-4 grid grid-cols-3 gap-2">
          {COVERAGE_DOMAIN_LABELS.map((label, i) => (
            ...
            >
              <span
                className="flex h-full items-center justify-center text-center text-[10px] font-semibold leading-tight"
        ...
        <span
          className="mt-4 inline-flex rounded-full border px-2.5 py-1 text-[10px] font-semibold uppercase tracking-wide"
          style={badgeStyle}
        >
          {tier}
        </span>
    ...
    <div className={cn('relative -mx-4 overflow-hidden px-4 sm:-mx-6 sm:px-6', pad)}>
      ...
      >
        <div className="min-w-0 max-w-4xl">
          <motion.p
            variants={mv.item}
            className="mb-5 inline-flex items-center rounded-full border px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.1em] sm:text-xs"
            style={{
