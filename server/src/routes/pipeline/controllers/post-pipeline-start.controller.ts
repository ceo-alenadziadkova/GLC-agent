...
export async function postPipelineStartController(req: AuthRequest, res: Response) {
  try {
    ...
    sendPipelineApiError(res, 500, API_ERROR_CODES.PIPELINE_START_FAILED, PIPELINE_START_FAILED_MESSAGE);
  }
}
