...
describe('SPA API_PATHS vs Express mount prefixes', () => {
  ...
  it('builder helpers produce paths under a mount prefix', () => {
    ...
    const samples = [
      ...
      ApiPaths.apiAuditsClientProjectContext('audit-id'),
      ApiPaths.apiAuditsIntakeFollowupSuggestions('audit-id'),
      ApiPaths.apiAuditsBriefCloneFrom('audit-id'),
      ApiPaths.apiAuditsBriefIntelligenceSnapshot('audit-id'),
      ...
      ApiPaths.apiIntakeIntelligenceSnapshot('tok'),
