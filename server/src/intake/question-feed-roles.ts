...
export const QUESTION_FEED_ROLES: Record<string, QuestionFeedRoles> = {
  ...
  b_growth_attempts: ps([D.mkt, D.strat]),
  b_hotel_1: ps([D.mkt]),
  b_hotel_2: ps([D.mkt]),
  ...
  c_nosite_3: ps([D.seo]),
  c_nosite_4: ps([D.auto, D.mkt]),
  c_nosite_5: ps([D.seo, D.mkt]),
  c_nosite_reviews: ps([D.mkt, D.seo], [D.auto]),
  d1: ps([D.auto, D.tech], [D.strat, D.seo]),
  d1a: ps([D.auto]),
  d1b: ps([D.auto]),
  d2: ps([D.auto], [D.ux, D.mkt]),
  d_automation_attempt: ps([D.auto]),
  d_response_time: ps([D.auto, D.ux]),
  d_closing_flow: ps([D.auto, D.ux]),
  d_billing_flow: ps([D.auto, D.security]),
  d3: ps([D.auto]),
  d4: ps([D.auto]),
