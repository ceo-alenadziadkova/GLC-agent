...
For **strict phases** (Tech, Security, UX, Marketing, Automation), do **not omit** this key. If evidence is incomplete, emit a **minimal valid** bundle with conservative defaults and explicit `evidence.missing` notes.
